							...
							<tr>
								<td>
									...
									<div class="input-group mb-2">
										...
										<input type="text" class="form-control col-md-10" id="quantidadeS" name="quantidadeS" maxlength="7" required>
									</div>
									...
									<div class="input-group mb-2">
										...
										<input type="text" class="form-control col-md-10" id="precoV" name="precoV" disabled="disabled" <?php echo "value='$precoV'"?> >
									</div>
								</td>
								<td>
									<div class="form-group p-2 m-1">
										<label for="dataS">Data</label>
										<input type="date" class="form-control col-md-12" id="dataS" name="dataS"  required >
									</div>	
								</td>
							</tr>
						</tbody>
...
<!----------------------------Rodape do Card-------------------------->
				<div class="card-footer m-1 bg-secondary text-white">
					<div class="btn-group btn-block " role="group" >
						<button type="submit" class="btn btn-dark btn-md border-white text-warning">Retirar</button>
					</div>
				</div>
			</div>
<!----------------------------Fim do Card----------------------------->
